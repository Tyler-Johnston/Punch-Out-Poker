...
public partial class PokerGame : Node2D
{
	...
	private PanelContainer opponentMoneyPanel;
	...
	{
		// Load resources
		cardVisualScene = GD.Load<PackedScene>("res://Scenes/Poker/CardVisual.tscn");
		...
		opponentMoneyPanel = GetNode<PanelContainer>("%OpponentMoneyPanel");
