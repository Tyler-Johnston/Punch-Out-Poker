...
public partial class PokerGame
{
	...
	private void UpdateDashboardColors(Color baseFeltColor, Color trimColor, Color outlineColor)
	{
		...
		if (betSlider != null)
		{
			string chipPath = "res://Assets/Textures/Poker/chip_pngs/yellow_1.png";
			switch (GameManager.Instance.GetCircuitType())
			{
				case 0: // Circuit A
					chipPath = "res://Assets/Textures/Poker/chip_pngs/yellow_1.png";
					break;
				case 1: // Circuit B
					chipPath = "res://Assets/Textures/Poker/chip_pngs/blue_1.png";
					break;
				case 2: // Circuit C
					chipPath = "res://Assets/Textures/Poker/chip_pngs/purple_1.png";
					break;
			}
	...
	private void LoadOpponentSprite()
	{
		...
		string folderPath = "res://Assets/Textures/Poker/expressions/";
	...
	private void UpdatePotDisplay(int potAmount)
	{
		...
		foreach (string chipFile in chipImages)
		{
			...
			string path = $"res://Assets/Textures/Poker/chip_pngs/{chipFile}";
